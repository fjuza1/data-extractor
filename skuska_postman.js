...
context.setProperty("ziskDat", ziskDatZoServisov);
context.setProperty("spracovanieDat", spracovanieDat);
log.info("ziskDatZoServisov set in context: " + context.getProperty("ziskDat"));
log.info("spracovanieDat set in context: " + context.getProperty("spracovanieDat"));
